package com.xuancao.anchors.handygridview;
...
import com.xuancao.anchors.handygridview.scrollrunner.ScrollRunner;
import com.xuancao.anchors.handygridview.utils.ReflectUtil;
import com.xuancao.anchors.handygridview.listener.IDrawer;
import com.xuancao.anchors.handygridview.listener.OnItemCapturedListener;
import com.xuancao.anchors.handygridview.scrollrunner.ICarrier;
import com.xuancao.anchors.handygridview.utils.SdkVerUtils;
...
public class HandyGridView extends GridView implements AdapterView.OnItemLongClickListener, AdapterView.OnItemClickListener, ICarrier {
    ...
    // mUseSelector建议 false,不要开启selector,不然item移动以后，在item原来的位置会有残影逐渐消失的效果。
